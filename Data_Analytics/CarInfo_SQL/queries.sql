...
--- 2. Find the total number of cars in the dataset: ---

SELECT COUNT(*) AS total_cars FROM car_info;
...
--- 4. Get the average selling price of cars:---
SELECT AVG(selling_price) AS average_selling_price FROM car_info;
